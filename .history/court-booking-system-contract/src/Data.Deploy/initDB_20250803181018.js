    ...
    static async init() {
        ...
        if (courtList[0].count === 0) {
            await this.#runQuery(`INSERT INTO ${Tables.COURT} 
                ...
                ('Shuttle Power Sports Complex', '136 Poorwarama Rd, Colombo 00600, Sri Lanka', 'Tennis', 1500.00, 'thameeshisenade@gmail.com', 'Outdoor hard court', 'Booked', 'pickleBall island.jpg', 1, '2025-05-11', '08:00', '18:00'),
                ('Blues Basketball Complex','Sri Sambuddhathva Jayanthi Mawatha , Colombo 05, Sri Lanka', 'Futsal', 2000.00, 'thameeshisenade@gmail.com', 'Artificial turf futsal court', 'Available', 'volleyball-court-construction.jpg', 1, '2025-05-12', '10:00', '20:00')
            `);
        }
