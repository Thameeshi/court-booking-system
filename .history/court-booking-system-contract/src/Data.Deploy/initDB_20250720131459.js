    ...
    static async init() {
        ...
        if (courtList[0].count === 0) {
            await this.#runQuery(`INSERT INTO ${Tables.COURT} 
                ...
                ('Futsal Court C', 'Huskies Basketball Court', 'Futsal', 20.00, 'thameeshisenade@gmail.com', 'Artificial turf futsal court', 'Available', 'volleyball-court-construction.png', 1, '2025-05-12', '10:00', '20:00')
            `);
        }
