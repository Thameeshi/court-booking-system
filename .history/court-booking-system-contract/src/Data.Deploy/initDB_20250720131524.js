    ...
    static async init() {
        ...
        if (courtList[0].count === 0) {
            await this.#runQuery(`INSERT INTO ${Tables.COURT} 
                ...
                VALUES 
                ('Badminton Court A', 'Blues Basketball Complex', 'Badminton | Table Tennis', 10.00, 'thameeshisenade@gmail.com', 'Indoor court with wooden flooring', 'Available', 'badminton court.jpg', 1, '2025-05-10', '09:00', '17:00'),
                ('Tennis Court B', 'Shuttle Power Sports Complex', 'Tennis | Basketball', 15.00, 'thameeshisenade@gmail.com', 'Outdoor hard court', 'Booked', 'pickleBall island.jpg', 1, '2025-05-11', '08:00', '18:00'),
                ('Futsal Court C', 'Huskies Basketball Court', 'Futsal | Cricket', 20.00, 'thameeshisenade@gmail.com', 'Artificial turf futsal court', 'Available', 'volleyball-court-construction.png', 1, '2025-05-12', '10:00', '20:00')
            `);
        }
