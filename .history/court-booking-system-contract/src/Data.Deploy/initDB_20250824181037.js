  ...
  static async init() {
    ...
    if (courtList[0].count === 0) {
      await this.#runQuery(`INSERT INTO ${Tables.COURT} 
        ...
        VALUES 
        ('Huskies Basketball Court', '475/5 Sigera Rd, Sri Jayawardenepura Kotte, Sri Lanka', 'Badminton', 1000.00, 'thameeshisenade@gmail.com', 'Indoor court with wooden flooring', 'Available','https://res.cloudinary.com/dhrejmsev/image/upload/v1753124854/badminton_court_yqevlh.webp','https://res.cloudinary.com/dhrejmsev/image/upload/v1753124854/badminton_court_yqevlh.webp','https://res.cloudinary.com/dhrejmsev/image/upload/v1753124854/badminton_court_yqevlh.webp', 1, '2025-05-10', '09:00', '17:00'),
        ('Shuttle Power Sports Complex', '136 Poorwarama Rd, Colombo 00600, Sri Lanka', 'Tennis', 1500.00, 'thameeshisenade@gmail.com', 'Outdoor hard court', 'Booked', 'https://res.cloudinary.com/dhrejmsev/image/upload/v1753865482/tennis_zhlw4r.jpg','https://res.cloudinary.com/dhrejmsev/image/upload/v1753865482/tennis_zhlw4r.jpg','https://res.cloudinary.com/dhrejmsev/image/upload/v1753865482/tennis_zhlw4r.jpg', 1, '2025-05-11', '08:00', '18:00'),
        ('Blues Basketball Complex','Sri Sambuddhathva Jayanthi Mawatha , Colombo 05, Sri Lanka', 'Futsal', 2000.00, 'thameeshisenade@gmail.com', 'Artificial turf futsal court', 'Available', 'https://res.cloudinary.com/dhrejmsev/image/upload/v1753866034/fustal_l0bljl.jpg','https://res.cloudinary.com/dhrejmsev/image/upload/v1753866034/fustal_l0bljl.jpg','https://res.cloudinary.com/dhrejmsev/image/upload/v1753866034/fustal_l0bljl.jpg', 1, '2025-05-12', '10:00', '20:00'),
        ('Basketball Court D', 'Community Center', 'Basketball', 25.00, 'thameeshisenade@gmail.com', 'Indoor basketball court', 'Available', 'https://res.cloudinary.com/dhrejmsev/image/upload/v1753124864/shutter_power_complex_s9xtfv.jpg','https://res.cloudinary.com/dhrejmsev/image/upload/v1753124864/shutter_power_complex_s9xtfv.jpg','https://res.cloudinary.com/dhrejmsev/image/upload/v1753124864/shutter_power_complex_s9xtfv.jpg', 1, '2025-05-13', '09:00', '21:00'),
        ('Squash Court E', 'Fitness Club', 'Squash', 18.00, 'thameeshisenade@gmail.com', 'Well-maintained squash court', 'Available', 'https://res.cloudinary.com/dhrejmsev/image/upload/v1753865641/sqash_ifyve0.jpg','https://res.cloudinary.com/dhrejmsev/image/upload/v1753865641/sqash_ifyve0.jpg','https://res.cloudinary.com/dhrejmsev/image/upload/v1753865641/sqash_ifyve0.jpg', 1, '2025-05-14', '08:00', '20:00'),
        ('Table Tennis Court F', 'Sports Complex', 'Table Tennis', 8.00, 'thameeshisenade@gmail.com', 'Indoor table tennis tables', 'Available', 'https://res.cloudinary.com/dhrejmsev/image/upload/v1753865770/Table-Tennis_jntlva.jpg','https://res.cloudinary.com/dhrejmsev/image/upload/v1753865770/Table-Tennis_jntlva.jpg','https://res.cloudinary.com/dhrejmsev/image/upload/v1753865770/Table-Tennis_jntlva.jpg', 1, '2025-05-15', '10:00', '18:00')
      `);
    }
