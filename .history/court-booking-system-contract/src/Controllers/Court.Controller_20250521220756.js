...
// NOTE: Actual Cloudinary upload logic should be in your HTTP API route (e.g., Express route),
// which receives the multipart/form-data, uploads the image to Cloudinary, and then calls this controller
// with the Cloudinary URL in data.Image.