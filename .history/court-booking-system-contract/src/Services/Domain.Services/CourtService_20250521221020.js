...
export class CourtService {
    ...
    async addCourt(data) {
        ...
        try {
            ...
            const courtEntity = {
                ...
                // Save the Cloudinary URL (string) in the Image field
            ...
            const rowValues = [
                ...
                courtEntity.Image, // This is now a Cloudinary URL string
                courtEntity.OwnerID,
            ...
            resObj.success = { message: "Court added successfully", courtId: result.lastID, changes: result.changes };
            return resObj;
        } catch (error) {
    ...
    async addAvailability(data) {
        ...
        try {
            ...
            // Update the court's availability fields
            const updateQuery = `
                UPDATE ${Tables.COURT}
