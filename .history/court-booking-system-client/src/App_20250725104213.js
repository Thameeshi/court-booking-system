...
const AppContent = () => {
  ...
  return (
    <>
      {/* Only show navbars if not on signup/register */}
      {!shouldHideNavbar && userDetails?.UserRole === "CourtOwner" && <DashboardNavbar />}
      {!shouldHideNavbar && userDetails?.UserRole === "PublicUser" && <UserNavbar />}
