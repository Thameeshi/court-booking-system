        ...
        <div className="header-content-wrapper">
          <div className="header-content">
            <div className="header-text">
              ...
              <button className="get-started-btn" onClick={() => navigate("/userdashboard/booking")}>Get Started</button>
          ...
          <div className="court-grid">
            {courts.slice(0, 6).map((court) => (
              ...
              <div className="court-card-image" style={{ marginTop: "30px" }}>
                <img
                  src={court.Image1 || court.Image2 || court.Image3 || "/default-court.jpg"}
                  alt={court.Name}
