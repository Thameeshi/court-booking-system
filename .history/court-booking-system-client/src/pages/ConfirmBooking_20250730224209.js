...
import courtService from "../services/domain-services/CourtService"; // Update path as needed
...
const ConfirmBookingBasic = () => {
  ...
  useEffect(() => {
    const fetchCourts = async () => {
      try {
        const response = await courtService.getAllCourts(); // Assumes a method like this exists
    ...
    <div style={containerStyle}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={fieldStyle}>
          ...
          <select name="courtId" value={formData.courtId} onChange={handleChange} style={inputStyle}>
