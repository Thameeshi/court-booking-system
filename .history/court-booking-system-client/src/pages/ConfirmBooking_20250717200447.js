...
const handleBookingSubmit = async (e) => {
  ...
  return (
    <div className="confirm-booking-vertical-container">
      {/* Notification message always visible on the form */}
      {successMessage && (
