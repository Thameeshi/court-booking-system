...
const ProfileInfo = () => {
  ...
  const handleBurnNFT = async () => {
    setBurnNotification(null); // Reset
    if (!tokenId) {
        ...
        <div className="card-body">
            ...
            {burnNotification && (
              <div
                className={`mt-2 alert ${
                  burnNotification.type === "success" ? "alert-success" : "alert-danger"
                }`}
              >
          ...
          <div className="mb-4">
            ...
            {buyNotification && (
              <div
                className={`mt-2 alert ${
                  buyNotification.type === "success" ? "alert-success" : "alert-danger"
                }`}
              >
