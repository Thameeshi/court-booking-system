...
const CreateCourt = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (NFTokenID) {
                ...
                // Optional: formDataToSend.append("NFTokenID", NFTokenID);
                // Optional: formDataToSend.append("NFTokenSellOffer", nfTokenSellOffer);
    ...
    return (
        <div className="container mt-5">
            ...
            {/* Same court listing code remains untouched */}
            {/* ... */}
        </div>
    );
};
