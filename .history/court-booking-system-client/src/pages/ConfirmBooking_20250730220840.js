...
const ConfirmBooking = () => {
  ...
  // Fetch booked slots for the court on selected date
  useEffect(() => {
  ...
  // Parse time string like "01:15 PM" into [hour, minute, period]
  ...
  // Check if selected time slot overlaps with any booked slot
  ...
  // Render select inputs for hours, minutes, and AM/PM
  const renderTimeOptions = (type) => {
    ...
    return (
      <>
        <select name={hourKey} className="form-select" value={bookingDetails[hourKey]} onChange={handleInputChange} required>
        ...
        <select name={minuteKey} className="form-select" value={bookingDetails[minuteKey]} onChange={handleInputChange} required>
        ...
        <select name={periodKey} className="form-select" value={bookingDetails[periodKey]} onChange={handleInputChange} required>
