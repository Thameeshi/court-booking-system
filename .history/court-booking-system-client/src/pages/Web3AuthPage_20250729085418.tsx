  ...
  return (
    <div
      ...
      style={{
        minHeight: "100vh",
        width: "100vw",
        background: `linear-gradient(120deg, #e0ffe7 0%, #b4ebc0 100%), url(${process.env.PUBLIC_URL}/greencourt.jpg) center center / cover no-repeat`,
        display: "flex",
        alignItems: "center",
    ...
    >
      ...
      >
        ...
        />
        <h2 style={{ color: "#0e6304", marginBottom: 8, fontWeight: 700, letterSpacing: 1 }}>Courtify Login</h2>
        <p style={{ color: "#2e7d32", fontSize: "1rem", marginBottom: 28, textAlign: "center" }}>
          Book your favorite sports court anytime, anywhere.<br />
          Hassle-free reservations at your fingertips!
        </p>
        {loading ? (
