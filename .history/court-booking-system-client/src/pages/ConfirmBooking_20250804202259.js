...
const handleBookingSubmit = async (e) => {
  ...
  try {
    console.log("Calling courtService.createBooking...");
    ...
    if (response && (response.success || response.message === "Booking created successfully" || response.id)) {
      console.log("Success response detected, setting states...");
      setIsProcessing(false);
      setShowSuccess(true);
      ...
      console.log("Navigating to payment in 1 second...");
      setTimeout(() => {
      ...
      console.log("Unclear response, navigating anyway...");
      setIsProcessing(false);
      setShowSuccess(true);
