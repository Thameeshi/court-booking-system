...
const ConfirmBooking = () => {
      ...
      if (court && bookingDetails.date) {
        try {
          ...
          if (response && response.success && Array.isArray(response.success)) {
            ...
            console.log("Booked slots:", response.success);
          } else {
            setBookedSlots([]);
          }
        } catch {
  ...
  const isSlotBooked = (startHour, startMinute, startPeriod, endHour, endMinute, endPeriod) => {
    ...
    return bookedSlots.some((b) => {
      ...
      console.log("Booked slot:", bStart, "-", bEnd);
  ...
  return (
    <div className="confirm-booking-container">
      ...
      <form onSubmit={handleBookingSubmit}>
        ...
        {/* Show warning if slot is already booked */}
        {!errorMessage &&
          isSlotBooked(
        ...
        {/* Show backend error (e.g., booking conflict) */}
        {errorMessage && (
