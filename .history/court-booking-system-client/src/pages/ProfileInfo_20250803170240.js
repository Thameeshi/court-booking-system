      ...
      <div style={{
        ...
        <div style={{ padding: "40px 60px", color: "#0e6304" }}>
          ...
          <section style={{ marginBottom: 40, borderBottom: "2px solid rgba(14, 99, 4, 0.3)", paddingBottom: 20 }}>
            <h2 style={{ fontSize: "1rem", marginBottom: 18, fontWeight: "600" }}>Profile Information</h2>
          ...
          <section style={{ marginTop: 30 }}>
            <h3 style={{ fontSize: "1.6rem", fontWeight: "600", marginBottom: 12 }}>Create Sell Offer</h3>
            <input
              type="text"
          ...
          {/* Burn NFT */}
          <section style={{ marginTop: 30 }}>
            <h3 style={{ fontSize: "1.6rem", fontWeight: "600", marginBottom: 12 }}>Burn NFT</h3>
            <input
              type="text"
          ...
          {/* Buy Offer */}
          <section style={{ marginTop: 30 }}>
            <h3 style={{ fontSize: "1.6rem", fontWeight: "600", marginBottom: 12 }}>Buy Sell Offer</h3>
            <input
              type="text"
