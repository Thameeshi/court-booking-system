  ...
  return (
    <>
      <div className="mybookings-container">
        ...
        <p className="mybookings-caption" style={{ color: "#2e7d32", marginBottom: "18px", fontSize: "1.08rem" }}>
          Easily view all your reserved courts below. You can cancel any upcoming booking with a single click!
        </p>
