...
const CancelBooking = () => {
  ...
  // Fix: get booking object from state and extract Id
  ...
  const handleCancel = async (e) => {
    ...
    try {
      ...
      if (response && response.success) {
        setMessage(
          "Your booking has been cancelled. If cancellation is made at least 24 hours before the start time, a refund will be issued."
        );
        setError("");
      } else {
