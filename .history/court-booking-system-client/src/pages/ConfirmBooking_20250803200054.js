  ...
  return (
    <div className="confirm-booking-container">
      ...
      <div style={{ 
        ...
        showSlotConflict: {showSlotConflict.toString()}<br/>
        showPaymentRedirect: {showPaymentRedirect.toString()}<br/>
        showSuccess: {showSuccess.toString()}<br/>
        ...
        <div className="form-item">
          ...
          {showSlotConflict && (
            <div className="alert alert-warning mt-2 mb-0" style={{ 
              ...
              <small>This time slot is unavailable. Please select a different time for "{court?.Name}".</small>
            </div>
          )}
        </div>
