...
const ManageCourt = () => {
    ...
    // Use a local fallback image for reliability
    const fallbackImage = "/no-image.png"; // Place no-image.png in your public folder
                ...
                <div className="row">
                    {courts.map((court) => (
                        <div className="col-md-4 mb-4" key={court.Id}>
                            <div className="card">
                                <img
                                    src={court.Image ? court.Image : fallbackImage}
                                    alt={court.Name}
