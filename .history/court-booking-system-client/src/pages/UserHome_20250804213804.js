    ...
    <div className="header-content">
      <div className="header-text">
        <h1 className="animated-text">
          <span>Decentralized</span> | <span>Secure</span> | <span>Verifiable</span><br />
          <span>Book</span> your <span>court</span> with <span>Crypto</span> Confidence
        </h1>
        <p className="header-subtext">
          Explore NFT-powered bookings with real-time availability & instant blockchain verification.
        </p>
        <div className="cta-buttons">
          <button className="get-started-btn">Book Now</button>
