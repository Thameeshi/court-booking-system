    ...
    static async init() {
        ...
        if (courtList[0].count === 0) {
            await this.#runQuery(`INSERT INTO ${Tables.COURT} 
                ...
                VALUES 
                ('Badminton Court A', 'Downtown Sports Arena', 'Badminton', 10.00, 'hayeshahp6@gmail.com', 'Indoor court with wooden flooring', 'Available','https://res.cloudinary.com/dhrejmsev/image/upload/v1753124854/badminton_court_yqevlh.webp', 1, '2025-05-10', '09:00', '17:00'),
                ('Tennis Court B', 'Uptown Club', 'Tennis', 15.00, 'hayeshahp6@gmail.com', 'Outdoor hard court', 'Booked', 'https://res.cloudinary.com/dhrejmsev/image/upload/v1753124864/shutter_power_complex_s9xtfv.jpg', 1, '2025-05-11', '08:00', '18:00'),
                ('Futsal Court C', 'City Park', 'Futsal', 20.00, 'hayeshahp6@gmail.com', 'Artificial turf futsal court', 'Available', 'https://res.cloudinary.com/dhrejmsev/image/upload/v1753124884/pickleBall_island_isxabk.png', 1, '2025-05-12', '10:00', '20:00')
            `);
        }
