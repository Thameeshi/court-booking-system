    ...
    static async init() {
        ...
        if (courtList[0].count === 0) {
            await this.#runQuery(`INSERT INTO ${Tables.COURT} 
                ...
                VALUES 
                ('Badminton Court A', 'Downtown Sports Arena', 'Badminton', 10.00, 'thameeshisenade@gmail.com', 'Indoor court with wooden flooring', 'Available', 'badminton court.jpg', 1, '2025-05-10', '09:00', '17:00'),
                ...
                ('Futsal Court C', 'City Park', 'Futsal', 20.00, 'thameeshisenade@gmail.com', 'Artificial turf futsal court', 'Available', 'volleyball-court-construction.jpg', 1, '2025-05-12', '10:00', '20:00')
            `);
        }
